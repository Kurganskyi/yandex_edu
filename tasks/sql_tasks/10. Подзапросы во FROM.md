...
FROM
  (SELECT billing_country AS country,
   ...
   GROUP BY billing_country, EXTRACT(MONTH FROM CAST(invoice_date AS DATE))) AS monthly_avg
GROUP BY monthly_avg.country
HAVING SUM(monthly_avg.avg_total) > 10;
```